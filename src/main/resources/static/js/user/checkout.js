...
app.controller(
  "checkoutController",['$scope', '$http', '$uibModal', function($scope, $http, $uibModal) {
  ...
  $scope.showSelectedInfoModal = function () {
    ...
    var modalInstance = $uibModal.open({
        ...
        controller: 'ModalInstanceCtrl', // Create a separate controller for the modal
        resolve: {
...
app.controller('ModalInstanceCtrl', ['$scope', '$uibModalInstance', 'selectedInfo', '$http', function($scope, $uibModalInstance, selectedInfo,$http) {
  ...
  $http.get("/rest/profile/customer")
    ...
    $scope.addAddress = function() {
      if($scope.selectedProvince === null || $scope.selectedDistrict === null || $scope.selectedWard === null || $scope.newAddress.duong === '' || $scope.newAddress.duong === null){
