...
(function (h) {
  ...
  m.defaults = {
    ...
    oLanguage: {
      ...
      sInfo: "Đang hiển thị từ  _START_ đến _END_ trong _TOTAL_ sản phẩm",
      sInfoEmpty: "Đang hiển thị từ 0 đến 0 trong 0 sản phẩm",
      sInfoFiltered: "(Tìm kiếm trong _MAX_ sản phẩm)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
